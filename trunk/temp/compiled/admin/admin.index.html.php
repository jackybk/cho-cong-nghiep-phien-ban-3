...
<div id="rightTop">
  ...
  <ul class="subnav">
    ...
    <li><a class="btn1" href="index.php?app=admin&amp;act=add">Thêm mới</a></li>
  </ul>
</div>
...
<div class="tdare">
  ...
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr1">
      ...
      <td>Tên người dùng | Họ và tên</td>
...
?>
    <tr class="tatr2">
      ...
      <td class="handler">
      <?php if ($this->_var['admin']['privs'] == all): ?>Quản trị viên
      </td>
      <?php else: ?>
      <span style="width: 120px">
      <a href="index.php?app=admin&amp;act=edit&amp;id=<?php echo $this->_var['admin']['user_id']; ?>">Sửa</a> | <a href="javascript:drop_confirm('Bạn có chắc chắn muốn xóa nó?', 'index.php?app=admin&amp;act=drop&amp;id=<?php echo $this->_var['admin']['user_id']; ?>');">Hủy bỏ</a>
      </span>
      </td>
      <?php endif; ?>
    </tr>
