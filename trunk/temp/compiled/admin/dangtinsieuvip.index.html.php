              ...
              <table style="font-size:12px">
               <tr>
                      <td class="searchSetAutoUP">
                          <div class="titleSearchAuto">Tìm kiếm tin rao vặt bạn muốn sử dụng tính năng Đăng tin Siêu vip</div>
                      </td>
                   </tr>
                   
                   <tr>
                       <td class="searchSetAutoUP">
		                   <form action="index.php?app=plquanly&amp;act=key_sieuvip" method="POST" enctype="multipart/form-data">               
...
?>
                          <fieldset>
                                <legend>Tin rao vặt bạn muốn Đăng tin siêu VIP</legend>
                                <form method="POST" action="index.php?app=plquanly&amp;act=capnhattinsieuvip&amp;id=<?php echo $this->_var['key']['id']; ?>" enctype="multipart/form-data">
                                ...
                                <?php endif; ?>
									...
									<div class="inforGuideUser">
                                        <div class="buyGuideVip">
                                          Tính năng cập nhật Đăng tin Siêu VIP
                                        </div>		
                                        <div class="labelGuideUP">
                                        Bạn muốn Đăng tin Siêu VIP trong
