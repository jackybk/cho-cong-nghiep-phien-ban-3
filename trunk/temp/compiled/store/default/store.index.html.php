    ...
    <div id="right">
        ...
        <div class="module_special">
            <h2 class="common_title veins2">
                ...
                <span class="ico1"><span class="ico2">Sản phẩm Giới thiệu</span></span>
            </h2>
            <div class="wrap">
...
?>
        ...
        <div class="module_special">
            <h2 class="common_title veins2">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">Mua theo nhóm mới</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
...
?>
                        <li>
                            ...
                            <p><span>Mua theo nhóm:&nbsp;</span><?php echo price_format($this->_var['groupbuy']['price']); ?></p>
                            <div class="time">Thời gian còn lại:&nbsp;<?php echo $this->_var['groupbuy']['lefttime']; ?></div>
                        </li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
        ...
        <div class="module_special">
            <h2 class="common_title veins2">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">Sản phẩm mới</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
...
?>
                    ...
                    <?php else: ?>
                    <div class="nothing"><p>Xin lỗi! Không có sản phẩm liên quan.</p></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
