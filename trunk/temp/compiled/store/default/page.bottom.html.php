...
<div class="shop_list_page">
    <div class="page">
        <a class="stat"><?php echo sprintf('', $this->_var['page_info']['item_count']); ?></a>
...
?>
        ...
        <a class="page_hover"><?php echo $this->_var['page']; ?></a>
        <?php else: ?>
        ...
        <a class="down" href="<?php echo $this->_var['page_info']['next_link']; ?>#module">Tiếp theo</a>
        <?php else: ?>
