...
<?php endif; ?>
<input id="submit_button" <?php if ($this->_var['act'] == 'uploadedfile'): ?>style="display:none"<?php endif; ?> type="button" value="<?php if ($this->_var['act'] == 'uploadedfile'): ?>Tải lên<?php endif; ?><?php if ($this->_var['act'] == 'remote_image'): ?>Gửi<?php endif; ?>" onclick="submit_form($(this))">
</form>
</body>
</html>