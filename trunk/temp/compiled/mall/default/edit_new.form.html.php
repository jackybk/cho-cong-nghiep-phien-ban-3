...
//]]>
    ...
    <div id="warning"></div>
   <form method="post" action="index.php?app=qldangtin&amp;act=edit&amp;id=<?php echo $this->_var['dtin']['id']; ?>&amp;user_id=<?php echo $this->_var['dtin']['user_id']; ?>&amp;picture=<?php echo $this->_var['dtin']['picture']; ?>" enctype="multipart/form-data" id="partner_form">
        <table width="95%" cellspacing="10" cellpadding="0" border="0" align="center">
          ...
          <?php else: ?>
			<td>Hình ảnh</td>
			<td>
                  <img src="<?php echo $this->_var['dtin']['picture']; ?>" width="100" height="100">
			</td>
		 </tr>
            <?php endif; ?>
            <tr>
