...
?>
                 <?php if ($this->_var['tinvip']): ?>
	                   ...
	                   <td><a href="index.php?app=qldangtin&act=xoatinsieuvip&amp;id=<?php echo $this->_var['vip']['id']; ?>" class="delete">Xóa</a></td>                       <?php if ($this->_var['vip']['picture']): ?>
	                      ...
	                      <td class="tinvip" align="center"><a href="index.php?app=qldangtin&amp;act=tinsieuvip&amp;id=<?php echo $this->_var['vip']['id']; ?>"><img border="0" align="absmiddle" alt="đăng siêu tin vip" title="đăng tin siêu vip" src="data/files/mall/icon_plus.gif">&nbsp;Đăng tin Siêu VIP</a> </td>
