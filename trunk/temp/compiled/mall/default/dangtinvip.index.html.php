        ...
        <div class="wrap">
            <div class="public table">
               <table style="font-size:12px">
                   ...
                   <tr>
                       <td class="searchSetAutoUP">
		                   <form action="index.php?app=qldangtin&amp;act=key_vip" method="POST" enctype="multipart/form-data">               
...
?>
                          <fieldset>
                                ...
                                <form method="POST" action="index.php?app=qldangtin&amp;act=dangtinvip&amp;id=<?php echo $this->_var['key']['id']; ?>" enctype="multipart/form-data">
                                <?php if ($this->_var['timkiem']): ?>
