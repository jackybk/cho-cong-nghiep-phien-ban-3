        ...
        <div class="article_wrap">
            <div class="article_con">
                ...
                <div class="more_article">
                    <h3>Bài trước: <?php if ($this->_var['pre_article']): ?><a target="<?php echo $this->_var['pre_article']['target']; ?>" href="<?php echo url('app=article&act=view&article_id=' . $this->_var['pre_article']['article_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['pre_article']['title']); ?></a> <span><?php echo local_date("Y-m-d H:i",$this->_var['pre_article']['add_time']); ?></span><?php else: ?>Không có hồ sơ<?php endif; ?></h3>
                    <h3>Bài tiếp theo: <?php if ($this->_var['next_article']): ?><a target="<?php echo $this->_var['next_article']['target']; ?>" href="<?php echo url('app=article&act=view&article_id=' . $this->_var['next_article']['article_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['next_article']['title']); ?></a> <span><?php echo local_date("Y-m-d H:i",$this->_var['next_article']['add_time']); ?></span><?php else: ?>Không có hồ sơ<?php endif; ?></h3>
                </div>
            </div>
        </div>
    </div>
