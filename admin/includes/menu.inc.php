...
return array(
    ...
    // 扩展
    'quanly' => array(
        'text'      => Lang::get('quanly'),
        'default'   => 'plquanly',
        'children'  => array(
            'plquanly' => array(
                'text'  => Lang::get('plquanly'),
                'url'   => 'index.php?app=plquanly',
            ),
			'qlsukien' => array(
                'text'  => Lang::get('qlsukien'),
                'url'   => 'index.php?app=qlsukien',
            )
			,
			'dmchungloai' => array(
                'text'  => Lang::get('dmchungloai'),
                'url'   => 'index.php?app=dmchungloai',
            ),
			'tudonguptin' => array(
                'text'  => Lang::get('tudonguptin'),
                'url'   => 'index.php?app=plquanly&amp;act=uptin',
            ),
			'tinraovatvip' => array(
                'text'  => Lang::get('tinraovatvip'),
                'url'   => 'index.php?app=plquanly&amp;act=tinraovatvip',
            )
			,
			'tinraovatsieuvip' => array(
                'text'  => Lang::get('tinraovatsieuvip'),
                'url'   => 'index.php?app=plquanly&amp;act=tinraovatsieuvip',
            )
