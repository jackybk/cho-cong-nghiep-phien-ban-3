                ...
                <div class="art-post-body no-padding">
					<div class="art-post-inner art-article">
						<h2 class="art-postheader">
                            Cửa hàng có 1222 sản phẩm trong <?php echo $this->_var['page_info']['page_count']; ?> trang
                        </h2>
                        <div id="module_goods">
...
?>
							<div class="product_vert">
								<div class="thumb thumb_162">
									...
									<span class="item_price"><span><?php echo price_format($this->_var['sgoods']['price']); ?></span></span>
									<a class="cropper" href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['sgoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['sgoods']['goods_name']); ?></a>
								</div>
								<div class="item_details">
									<p class="top_detail"><a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['sgoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['sgoods']['goods_name']); ?></a></p>
								</div>
								<div class="buy_now"><a href="<?php echo url('app=goods&id=' . $this->_var['sgoods']['goods_id']. ''); ?>" class="art-button">Đặt hàng</a></div>
								<div class="clear"></div>
							</div>
