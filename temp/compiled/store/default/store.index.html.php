...
?>
							<div class="product_vert">
								<div class="thumb thumb_162">
									<img src="<?php echo $this->_var['ngoods']['default_image']; ?>" alt="<?php echo htmlspecialchars($this->_var['ngoods']['goods_name']); ?>"/>
									<span class="item_price"><span><?php echo price_format($this->_var['rgoods']['price']); ?></span></span>
									<a class="cropper" href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['ngoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['ngoods']['goods_name']); ?></a>
								</div>
								<div class="item_details">
									<p class="top_detail"><a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['ngoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['ngoods']['goods_name']); ?></a></p>
								</div>
								<div class="buy_now"><a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" class="art-button">Đặt hàng</a></div>
								<div class="clear"></div>
							</div>
			...
			<div class="art-post">
                ...
                <div class="art-post-body no-padding">
					<div class="art-post-inner art-article">
						<div class="nothing"><p>Cửa hàng đang cập nhật sản phẩm ...</p></div>
						<div class="guide_buy">
							<span>Mời bạn</span>
							<a href="<?php echo url('app=category&act=store'); ?>" class="art-button" id="other_store">Xem các cửa hàng khác</a>
							<span class="">hoặc quay về</span>
							<a href="<?php echo $this->_var['site_url']; ?>" class="art-button" id="unit_web">Chợ công nghiệp</a>
						</div>
                        <div class="cleared"></div>
					</div>
            		<div class="cleared"></div>
...
?>
							<div class="product_vert">
								<div class="thumb thumb_162">
									...
									<span class="item_price"><span><?php echo price_format($this->_var['rgoods']['price']); ?></span></span>
									<a class="cropper" href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['rgoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['rgoods']['goods_name']); ?></a>
								</div>
								<div class="item_details">
									<p class="top_detail"><a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['rgoods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['rgoods']['goods_name']); ?></a></p>
								</div>
								<div class="buy_now"><a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. ''); ?>" class="art-button">Đặt hàng</a></div>
								<div class="clear"></div>
							</div>
							<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
						</div>
...
?>
							<div class="product_vert">
								<div class="thumb thumb_162">
									<img src="<?php echo $this->_var['groupbuy']['default_image']; ?>" alt="<?php echo htmlspecialchars($this->_var['groupbuy']['group_name']); ?>"/>
									<span class="item_price"><span><?php echo price_format($this->_var['rgoods']['price']); ?></span></span>
									<a class="cropper" href="<?php echo url('app=groupbuy&id=' . $this->_var['groupbuy']['group_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['groupbuy']['group_name']); ?>"><?php echo htmlspecialchars($this->_var['groupbuy']['group_name']); ?></a>
								</div>
								<div class="item_details">
									<p class="top_detail"><a href="<?php echo url('app=groupbuy&id=' . $this->_var['groupbuy']['group_id']. ''); ?>" title="<?php echo htmlspecialchars($this->_var['groupbuy']['group_name']); ?>"><?php echo htmlspecialchars($this->_var['groupbuy']['group_name']); ?></a></p>
								</div>
								<div class="buy_now"><a href="<?php echo url('app=groupbuy&id=' . $this->_var['groupbuy']['group_id']. ''); ?>" class="art-button">Đặt hàng</a></div>
								<div class="clear"></div>
							</div>
							<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
						</div>
