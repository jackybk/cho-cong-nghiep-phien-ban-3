<div id="nav">
    ...
    <ul>
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'index'): ?>active<?php else: ?>normal<?php endif; ?>" href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>"><span>Cửa hàng</span></a></li>
        <?php if ($this->_var['store']['functions']['groupbuy']): ?>
        <li><a class="<?php if ($_GET['app'] == 'groupbuy' || $_GET['act'] == 'groupbuy'): ?>active<?php else: ?>normal<?php endif; ?>" href="<?php echo url('app=store&act=groupbuy&id=' . $this->_var['store']['store_id']. ''); ?>"><span>Mua theo nhóm</span></a></li>
        <?php endif; ?>
...
?>
        ...
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'credit'): ?>active<?php else: ?>normal<?php endif; ?>" href="<?php echo url('app=store&act=credit&id=' . $this->_var['store']['store_id']. ''); ?>"><span>Đánh giá uy tín</span></a></li>
        <a class="collection" href="javascript:collect_store(<?php echo $this->_var['store']['store_id']; ?>)">Bộ sưu tập</a>
    </ul>
