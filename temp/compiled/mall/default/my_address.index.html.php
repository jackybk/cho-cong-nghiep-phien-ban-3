...
<div class="content">
    ...
    <div id="right">
        ...
        <div class="wrap">
            <div class="eject_btn" title="Thêm địa chỉ"><b class="ico1" ectype="dialog" dialog_title="Thêm địa chỉ" dialog_id="my_address_add" dialog_width="600" uri="index.php?app=my_address&act=add">Thêm địa chỉ</b></div>
            ...
            <div class="public table">
                <table class="table_head_line">
                    ...
                    <tr class="line tr_color">
                        ...
                        <th>Khu vực</th>
                        <th class="width3">Tầng 2, 32B Lạc Trung, Hai Bà Trưng, Hà Nội</th>
                        <th>Mã bưu điện</th>
                        <th class="width5">Phone / Cell Phone</th>
                        <th>Hành động</th>
                    </tr>
                    <?php endif; ?>
...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold tr_align"><?php else: ?><tr class="line tr_align"><?php endif; ?>
                        ...
                        <td> <a href="javascript:void(0);" ectype="dialog" dialog_id="my_address_edit" dialog_title="Chỉnh sửa" dialog_width="700" uri="index.php?app=my_address&act=edit&addr_id=<?php echo $this->_var['address']['addr_id']; ?>" class="edit1 float_none">Sửa</a>
                            <a href="javascript:drop_confirm('Bạn có chắc chắn muốn xóa nó ?', 'index.php?app=my_address&amp;act=drop&addr_id=<?php echo $this->_var['address']['addr_id']; ?>');" class="delete float_none">Xoá</a></td>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr>
                        <td colspan="6" class="member_no_records padding6"><?php echo $this->_var['lang'][$_GET['act']]; ?>Bạn không thêm địa chỉ vận chuyển</td>
                    </tr>
