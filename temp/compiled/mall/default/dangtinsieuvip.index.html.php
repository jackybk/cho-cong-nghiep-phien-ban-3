        ...
        <div class="wrap">
            <div class="public table">
               <table style="font-size:12px">
                   ...
                   <tr>
                       <td class="searchSetAutoUP">
		                   <form action="index.php?app=qldangtin&amp;act=key_sieuvip" method="POST" enctype="multipart/form-data">               
...
?>
                          <fieldset>
                                ...
                                <form method="POST" action="index.php?app=qldangtin&amp;act=tinsieuvip&amp;id=<?php echo $this->_var['key']['id']; ?>" enctype="multipart/form-data">
