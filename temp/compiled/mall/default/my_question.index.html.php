...
?>
                    <tr class="bgcolor line_normal">
                        ...
                        <td class="width8">
                            <span class="table_user"><?php if ($this->_var['my_qa_list']['user_name'] != ''): ?><?php echo htmlspecialchars($this->_var['my_qa_list']['user_name']); ?><?php else: ?>Lượt truy cập<?php endif; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?>class="line_bold"<?php endif; ?>>
                        <td></td>
                        <td>
                            <h3><span class="color8">Cửa hàng trả lời:&nbsp;</span></h3>
                    ...
                    <?php endforeach; else: ?>
                    <tr char="bgcolor">
                        <td colspan="3" class="member_no_records"><?php echo $this->_var['lang'][$_GET['act']]; ?>Không có hồ sơ</td>
                    </tr>
