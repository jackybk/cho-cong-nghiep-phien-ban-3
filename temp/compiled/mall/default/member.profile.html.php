...
$(function(){
    $('#profile_form').validate({
        ...
        messages : {
            portrait  : {
                accept   : 'Hỗ trợ định dạng gif, jpeg, jpg, png'
            }
        }
    });
                ...
                <form method="post" enctype="multipart/form-data" id="profile_form">
                    <div class="information">
                        ...
                        <div class="info individual">
                            <table>
                                <tr>
                                    <th class="width4">Tên đăng nhập: </th>
                                ...
                                <tr>
                                    ...
                                    <td class="label">
                                        <label>
                                           <input type="radio" name="gender" value="0" <?php if ($this->_var['profile']['gender'] == 0): ?>checked="checked"<?php endif; ?> />Bí mật  </label>
                                            <label>
                                            <input type="radio" name="gender" value="1" <?php if ($this->_var['profile']['gender'] == 1): ?>checked="checked"<?php endif; ?> />Nam   </label>
                                            <label>
                                            <input type="radio" name="gender" value="2" <?php if ($this->_var['profile']['gender'] == 2): ?>checked="checked"<?php endif; ?> />Nữ </label>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Sinh nhật: </th>
                                ...
                                <tr>
                                    <th></th>
                                    <td><input type="submit" class="btn" value="Lưu thay đổi" /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
