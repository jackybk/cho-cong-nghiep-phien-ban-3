                ...
                <table>
                    ...
                    <tr class="line_bold">
                        ...
                        <th colspan="5">
                            ...
                            <a class="detlink" style="float:right" href="<?php echo url('app=buyer_groupbuy'); ?>">Hủy tìm kiếm</a>
                            <?php endif; ?>
                    ...
                    <tr class="gray">
                        <th width="50"> </th>
                        <th width="100"><span>Tên sự kiện</span></th>
                        <th width="50"><span>Hoạt động</span></th>
                        <th width="80"><span>Ngày kết thúc</span></th>
                    <th width="80"><span>Số lượng đặt hàng/Số lượng tối thiểu</span></th>
                        <th width="130">Thông tin chi tiết đặt hàng</th>
...
?>
                        <?php if ($this->_var['spec']['qty'] > 0): ?><?php if ($this->_var['spec']['spec']): ?><?php echo $this->_var['spec']['spec']; ?><?php else: ?>Số lượng tối đa<?php endif; ?>: <?php echo $this->_var['spec']['qty']; ?>Mục<?php endif; ?><br />
...
?>
                        ...
                        <a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group']['group_id']. ''); ?>" class="view">Xem</a>
                        <?php elseif ($this->_var['name'] == 'buy'): ?>
                        <a target="_blank" href="<?php echo url('app=order&goods=groupbuy&group_id=' . $this->_var['group']['group_id']. ''); ?>" class="buy">Mua</a>
                        <?php elseif ($this->_var['name'] == 'view_order'): ?>
                        <a target="_blank" href="<?php echo url('app=buyer_order&act=view&order_id=' . $this->_var['group']['order_id']. ''); ?>" class="view_order">Xem</a>
                        <?php elseif ($this->_var['name'] == 'exit_group'): ?>
                        <a href="javascript:drop_confirm('Bạn có chắc muốn thoát khỏi các hoạt động mua theo nhóm?','<?php echo url('app=buyer_groupbuy&act=exit_group&id=' . $this->_var['group']['group_id']. ''); ?>')" class="delete">Thoát</a>
                        <?php endif; ?>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </div></td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr>
                        <td class="align2 member_no_records padding6" colspan="7">Không có hồ sơ</td>
                    </tr>
