...
?>
            <div class="bring_forth">
                ...
                <div class="bring_forth_text w92 gleft">
                    ...
                    <p>
                        Chủ&nbsp;:<?php echo $this->_var['store']['user_name']; ?><br />
                        Sản phẩm&nbsp;:<?php echo $this->_var['store']['goods_count']; ?><br />
                        Uy tín&nbsp;:<?php echo $this->_var['store']['praise_rate']; ?>%
                    </p>
                </div>
            </div>
           <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <div class="right w780">
        <div class="linebox1">
            <h1><img alt="Tất cả thương hiệu" src="<?php echo $this->res_base . "/" . 'images'; ?>/brands_list.gif" /></h1>
            <?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand');if (count($_from)):
    foreach ($_from AS $this->_var['brand']):
?>
            <div class="linebox_dt"><?php if ($this->_var['brand']['tag']): ?><?php echo $this->_var['brand']['tag']; ?><?php else: ?>Tất cả Thương hiệu<?php endif; ?> (<?php echo $this->_var['brand']['count']; ?>)</div>
            <ul class="brands_pic">
