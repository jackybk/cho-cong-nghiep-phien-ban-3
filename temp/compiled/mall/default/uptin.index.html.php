        ...
        <div class="wrap">
            <div class="public table">
               <table style="font-size:12px">
                   ...
                   <tr>
                       <td class="searchSetAutoUP">
		                   <form action="index.php?app=qldangtin&amp;act=keyword" method="POST" enctype="multipart/form-data">               
                   ...
                   <tr>
                       <td valign="top">
                          <fieldset>
                                ...
                                <form method="POST" action="index.php?app=qldangtin&amp;act=uptin" enctype="multipart/form-data">
                                <?php if ($this->_var['timkiem']): ?>
...
?>
                                  ...
                                  &nbsp;&nbsp;
                                     <span style="font-weight:bold;"><a style="outline: medium none;text-decoration: none;"href="index.php?app=qldangtin&amp;act=doctin&amp;id=<?php echo $this->_var['key']['id']; ?>"><?php echo htmlspecialchars($this->_var['key']['title']); ?></a></span>
