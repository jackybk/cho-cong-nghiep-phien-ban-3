...
?>
	                   <tr class="tatr2">
	                   <td><a href="index.php?app=plquanly&act=xoatinvip&amp;id=<?php echo $this->_var['vip']['id']; ?>" class="delete">Xóa</a></td>
	                    ...
	                    <?php endif; ?>
	                      ...
	                      <td class="tinvip" align="center"><a href="index.php?app=plquanly&amp;act=dangtinvip&amp;id=<?php echo $this->_var['vip']['id']; ?>" class="delete"><img border="0" align="absmiddle" src="../data/files/mall/icon_plus.gif">&nbsp;Đăng tin VIP</a> </td>
