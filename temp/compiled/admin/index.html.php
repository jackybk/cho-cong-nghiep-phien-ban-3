...
<title>Quản trị hệ thống -- Powered by ECMall</title>
...
<div id="head">
    ...
    <div id="menu"><span>Xin chào, <strong><?php echo $this->_var['visitor']['user_name']; ?></strong> <a href="index.php?act=logout">[Thoát]</a> <a href="<?php echo $this->_var['site_url']; ?>/index.php" target="_blank">[Xem cửa hàng]</a></span>
    <a href="javascript:;" class="menu_btn2" id="iframe_refresh">Làm mới</a>
    <a href="javascript:;" class="menu_btn2" id="clear_cache">Xóa cache</a>
    ...
    <div id="left">
        <div id="leftMenus">
            ...
            <dl id="history" class="history">
                <dt>
                    <a class="ico2" id="historyText" href="#">Lịch sử quản trị</a>
                </dt>
            </dl>
         </div>
    </div>
