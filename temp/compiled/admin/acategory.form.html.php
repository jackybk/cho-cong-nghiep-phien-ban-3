    ...
    $('#acategory_form').validate({
        ...
        messages : {
            cate_name : {
                ...
                remote   : 'Tên thể loại đả tồn tại! Vui lòng kiểm tra lại'
            },
            sort_order  : {
                number   : 'Chỉ có thể là số'
            }
        }
    });
});
...
<div id="rightTop">
    ...
    <ul class="subnav">
        <li><a class="btn1" href="index.php?app=acategory">Danh sách</a></li>
        <li><?php if ($this->_var['acategory']['cate_id']): ?><a class="btn1" href="index.php?app=acategory&amp;act=add">Thêm mới</a><?php else: ?><span>Thêm mới</span><?php endif; ?></li>
    </ul>
</div>
        ...
        <table class="infoTable">
            <tr>
                ...
                <td class="paddingT15 wordSpacing5">
                    ...
                    <label class="field_notice">Tên danh mục tin tức thêm mới</label>              </td>
            </tr>
            <tr>
                <th class="paddingT15">
                    <label for="parent_id">Danh mục cha:</label></th>
                <td class="paddingT15 wordSpacing5">
                    <select id="parent_id" name="parent_id"><option value="0">Hãy chọn...</option><?php echo $this->html_options(array('options'=>$this->_var['parents'],'selected'=>$this->_var['acategory']['parent_id'])); ?></select>                </td>
            </tr>
            <tr>
                <th class="paddingT15">
                    Thứ tự hiển thị:</th>
                <td class="paddingT15 wordSpacing5">
                    ...
                    <label class="field_notice">Thứ tự hiển thị trên website</label>             </td>
            </tr>
