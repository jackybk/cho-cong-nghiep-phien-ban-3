...
<div id="rightTop">
    <p>Quản lý tỉnh/TP</p>
    <ul class="subnav">
        <li><a class="btn1" href="index.php?app=region">Danh sách</a></li>
        <li><?php if ($this->_var['region']['region_id']): ?><a class="btn1" href="index.php?app=region&amp;act=add">Thêm mới</a><?php else: ?><span>Thêm mới</span><?php endif; ?></li>
    </ul>
</div>
