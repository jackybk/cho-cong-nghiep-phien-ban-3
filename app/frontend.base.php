...
class MemberbaseApp extends MallbaseApp
{
    ...
    function _get_member_menu()
    {
        ...
        $menu['manager_new'] = array(
            'name'  => 'manager_new',
            'text'  => Lang::get('manager_new'),
            'submenu'   => array(
                'qldangtin'  => array(
                    'text'  => Lang::get('qldangtin'),
                    'url'   => 'index.php?app=qldangtin',
                    'name'  => 'qldangtin',
                    'icon'  => 'ico5',
                ),
                ...
                'uptin'  => array(
                    'text'  => Lang::get('uptin'),
                    'url'   => 'index.php?app=qldangtin&amp;act=uptin',
                    'name'  => 'uptin',
                    'icon'  => 'ico6',
                )
				,
				'tinraovatvip'  => array(
                    'text'  => Lang::get('tinraovatvip'),
                    'url'   => 'index.php?app=qldangtin&amp;act=tinraovatvip',
                    'name'  => 'tinraovatvip',
                    'icon'  => 'ico5',
                )
				,
				'tinraovatsieuvip'  => array(
                    'text'  => Lang::get('tinraovatsieuvip'),
                    'url'   => 'index.php?app=qldangtin&amp;act=tinraovatsieuvip',
                    'name'  => 'tinraovatsieuvip',
                    'icon'  => 'ico22',
                )
				,
				'tinquantam'  => array(
                    'text'  => Lang::get('tinquantam'),
                    'url'   => 'index.php?app=qldangtin&amp;act=tinquantam',
                    'name'  => 'tinquantam',
                    'icon'  => 'ico11',
                ),
				'tinsukien'  => array(
                    'text'  => Lang::get('tinsukien'),
                    'url'   => 'index.php?app=qldangtin&amp;act=tinsukien',
                    'name'  => 'tinsukien',
                    'icon'  => 'ico13',
                )
            ),
        );
       $menu['dangtinrv'] = array(
            'name'  => 'dangtinrv',
            'text'  => Lang::get('dangtinrv'),
            'submenu'   => array(
              'dangtin_raovat'  => array(
                    'text'  => Lang::get('dangtin_raovat'),
                    'url'   => 'index.php?app=dangtin',
                    'name'  => 'dangtin_raovat',
                    'icon'  => 'ico20',
                )
				,  
                'dangtinvip'  => array(
                    'text'  => Lang::get('dangtinvip'),
                    'url'   => 'index.php?app=qldangtin&amp;act=dangtinvip',
                    'name'  => 'dangtinvip',
                    'icon'  => 'ico17',
                ),
				'tinsieuvip'  => array(
                    'text'  => Lang::get('tinsieuvip'),
                    'url'   => 'index.php?app=qldangtin&amp;act=tinsieuvip',
                    'name'  => 'tinsieuvip',
                    'icon'  => 'ico15',
                ),
            ),
